...
public class EducationFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        final Spinner perTypeSpinner = getView().findViewById(R.id.secondarySpinner);
        final Spinner educationSpinner = getView().findViewById(R.id.degreeTypeSpinner);
        ...
        Button updateDetailsButton = getView().findViewById(R.id.updateDetails_button);
